...
//                .output(new TransactionOutput(GASAsset.HASH_ID, "7264", receivingAdr))
//                .claim(new TransactionInput(claimableTxId, idx))
//                .script(new Script(invocationScript, VerificationScript.fromPublicKey(publicKey).getScript())
//        ).build();
//
...
//        assertEquals(
//                new TransactionInput(txId, index),
//                claimTransaction.getClaims().get(0));
//        assertEquals(
//                new TransactionOutput(GASAsset.HASH_ID, claimValue, receivingAdr),
...
//
//        Script witness = Script.createWitness(unsignedTxArray, ecKeyPair);
...
//        TransactionInput in = new TransactionInput("887eb3e48f468dac5c42d4877cd5f0edde20bab79e288b43ad7cf8c0c6c657f1", 0);
//        TransactionOutput out = new TransactionOutput(GASAsset.HASH_ID, "0.78719928", "Ach3RRuGyFC3vQFA6AZ5yktuYB4jtQyT12");
//
