...
//        Transaction tUnsigned = new ContractTransaction.Builder()
//                .inputs(Arrays.asList(new TransactionInput("c94d0f94b0ac9bacd86737c428344cb2d8be9aad296659e85c065d4f88cd2dd2", 0)))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "10.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "90.0", "AKYdmtzCD6DtGx16KHzSTKY8ji29sMTbEZ"))
//                .script(new Script(new InvocationScript(), VerificationScript.fromPublicKey(publicKey)))
//                .build();
//
...
//        Transaction tUnsigned = new ContractTransaction.Builder()
//                .input(new TransactionInput("c94d0f94b0ac9bacd86737c428344cb2d8be9aad296659e85c065d4f88cd2dd2", 0))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "10.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "90.0", "AKYdmtzCD6DtGx16KHzSTKY8ji29sMTbEZ"))
//                .script((new Script(new InvocationScript(invocationScript), VerificationScript.fromPublicKey(publicKey))))
//                .build();
//
//        byte[] tUnsignedArray = tUnsigned.toArray();
//
...
//
//        Transaction tUnsigned = new ContractTransaction.Builder()
//                .input(new TransactionInput("65827ac7308f401dfe110555b41b967e3c1177134bd977a21ca036e703ab05d4", 0))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "10.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "90.0", "AKYdmtzCD6DtGx16KHzSTKY8ji29sMTbEZ"))
//                .build();
//
//        byte[] tUnsignedArray = tUnsigned.toArrayWithoutScripts();
//        tUnsigned.addScript(Script.createWitness(tUnsignedArray, keyPair));
//
//        assertEquals(
...
//
//        Transaction tUnsigned = new ContractTransaction.Builder()
//                .input(new TransactionInput("9feac4774eb0f01ab5d6817c713144b7c020b98f257c30b1105062d434e6f254", 0))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "100.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "900.0", multiSigAddress))
//                .build();
//
//        byte[] tUnsignedArray = tUnsigned.toArrayWithoutScripts();
//
...
//        tUnsigned.addScript(Script.createMultiSigWitness(7, sigs, publicKeys));
//
//        assertEquals(
...
//        assertArrayEquals(invScript, tx.getWitnesses().get(0).getInvocationScript().getScript());
//        byte[] verScript = Numeric.hexStringToByteArray("210265bf906bf385fbf3f777832e55a87991bcfbe19b097fb7c5ca2e4025a4d5e5d6ac");
//        assertArrayEquals(verScript, tx.getWitnesses().get(0).getVerificationScript().getScript());
//    }
//
//    @Test
...
//        byte[] rawTransactionArray = Numeric.hexStringToByteArray(rawTransaction);
//
//        Transaction transactionObj = NeoSerializableInterface.from(rawTransactionArray, ContractTransaction.class);
...
//
//        Transaction unsignedTx = new ContractTransaction.Builder()
//                .input(new TransactionInput("9feac4774eb0f01ab5d6817c713144b7c020b98f257c30b1105062d434e6f254", 0))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "100.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
//                .output(new TransactionOutput(NEOAsset.HASH_ID, "900.0", address))
//                .build();
//
...
//        TransactionInput in = new TransactionInput("7aadf91ca8ac1e2c323c025a7e492bee2dd90c783b86ebfc3b18db66b530a76d", 0);
//        TransactionOutput out = new TransactionOutput("c56f33fc6ecfcd0c225c4ab356fee59390af8560be0e930faebe74a6daff7c9b", "100000000", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y");
//
...
//
//        assertEquals(0, tx.getWitnesses().size());
...
//        assertEquals("AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y", tx.getOutputs().get(0).getAddress());
//        assertEquals("AKYdmtzCD6DtGx16KHzSTKY8ji29sMTbEZ", tx.getOutputs().get(1).getAddress());
//        assertEquals(1, tx.getWitnesses().size());
//        assertArrayEquals(invocationScript, tx.getWitnesses().get(0).getInvocationScript().getScript());
//        assertArrayEquals(
//                Keys.getVerificationScriptFromPublicKey(publicKey),
//                tx.getWitnesses().get(0).getVerificationScript().getScript()
//        );
//    }
}
