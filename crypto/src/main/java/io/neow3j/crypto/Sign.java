...
public class Sign {
    ...
    /**
     * <p>Recovers the address that created the given signature on the given message.</p>
     * <br>
     * <p>If the message is a Neo transaction, then make sure that it was serialized without the
     * verification and invocation script attached (i.e. without the signature).</p>
     *
